<!-- 象形柱状图 -->
<template>
  <div id="pictorialBar" v-if="$store.getters.moduleOptions.drawersNumber">
    <!-- 抽屉状态 -->
    <div class="title-new">
      <span class="title-new-bg">抽屉状态</span>
    </div>
...
export default {
  ...
  methods: {
    init() {
      ...
      var pathSymbols = {
        reindeer:
          "path://M512 58.395L120.531 285.82v453.605L512 965.607l391.469-227.425V285.818L512 58.393z m335.545 237.366L512 490.874 176.455 295.761 512 101.89l335.545 193.871z m-689.731 32.312l334.302 193.871-1.243 387.74-333.058-192.627V328.075zM528.156 913.41l1.243-388.982 336.787-196.355v388.982L528.156 913.41z",
...
#pictorialBar {
  .drawer-status {
    ...
    border-image: url("../assets/border/1/right_02.png") 28;
  }
}
</style>
